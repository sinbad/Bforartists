...
.. function:: create_grid(bm, x_segments, y_segments, size, matrix, calc_uvs)
   ...
   :type matrix: :class:`mathutils.Matrix`
   :arg calc_uvs: calculate default UVs
   :type calc_uvs: bool
   :return:
...
.. function:: create_uvsphere(bm, u_segments, v_segments, diameter, matrix, calc_uvs)
...
.. function:: create_icosphere(bm, subdivisions, diameter, matrix, calc_uvs)
...
.. function:: create_cone(bm, cap_ends, cap_tris, segments, diameter1, diameter2, depth, matrix, calc_uvs)
...
.. function:: create_circle(bm, cap_ends, cap_tris, segments, diameter, matrix, calc_uvs)
...
.. function:: create_cube(bm, size, matrix, calc_uvs)
