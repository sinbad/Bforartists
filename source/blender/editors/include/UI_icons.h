...
/*bfa - select icons */
DEF_ICON(SELECT_ALL)
DEF_ICON(SELECT_INVERSE)
DEF_ICON(SELECT_BORDER)
DEF_ICON(SELECT_CIRCLE)
DEF_ICON(SELECT_LASSO)
DEF_ICON(SELECT_LINKED)
DEF_ICON(SELECT_MORE)
DEF_ICON(SELECT_LESS)
/*bfa - edit icons grease pencil */
DEF_ICON(DELETE)
DEF_ICON(GREASEPENCIL_DISSOLVE)
DEF_ICON(DUPLICATE)
DEF_ICON(BEND)
DEF_ICON(SHEAR)
DEF_ICON(TO_SPHERE)
