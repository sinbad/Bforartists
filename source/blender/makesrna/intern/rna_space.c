...
EnumPropertyItem space_type_items[] = {
	...
	//{SPACE_LOGIC, "LOGIC_EDITOR", ICON_LOGIC, "Logic Editor", "Game logic editing"}, // bfa - disabled the logic editor in the menu since the Game engine is off. See also space_logic.py
	{0, "", ICON_NONE, NULL, NULL},
...
static void rna_def_space_view3d(BlenderRNA *brna)
{
	...
	prop = RNA_def_property(srna, "show_cursor", PROP_BOOLEAN, PROP_NONE); // bfa - show hide 3d cursor
	...
	prop = RNA_def_property(srna, "use_wire_color", PROP_BOOLEAN, PROP_NONE); // bfa - custom wireframe colors
